        ...
        <div class="row">
          <div class="col-md-10">
            ...
            <div class="panel-body">
                ...
                <div class="panel-heading">Liste des cas des prisonniers appartenant dans la categorie {{ $category_cas_prisonniers->nom_cat_cas }}</div>
            ...
            <form action="{{url('categorie')}}" method="POST">
                    ...
                    <input type="hidden" name="category_id" id="" value="{{ $category_cas_prisonniers->id }}" >
                    @error('nom_produit')
