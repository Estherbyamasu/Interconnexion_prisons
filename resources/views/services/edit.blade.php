...
<div class="panel panel-info"><!--/.row-->
    <h3 class="modal-title w-100 white-text font-weight-bold" id="myModalLabel"><strong>Modification de service</strong> <a
    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="panel panel-info">
                <div class="panel-heading">Modifier le service n&deg; {{ $service->id }}</div>
                    ...
                    <div class="col-md-12">
                        <form role="form" action="/services/{{ $service->id }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nom_service" class="form-control" placeholder="Entrez le nom du service" value="{{ $service->nom_service }}" >
                            </div>
                            <div class="row">
